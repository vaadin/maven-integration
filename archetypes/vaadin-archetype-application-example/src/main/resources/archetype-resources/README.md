...
- ${rootArtifactId}-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- ${rootArtifactId}-ui: main application module, development time
- ${rootArtifactId}-production: module that produces a production mode WAR for deployment
